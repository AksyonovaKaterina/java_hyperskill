...
import com.bad_java.homework.hyperskill.tictactoe_with_al.part_4.StateOfGame.Exit;
import com.bad_java.homework.hyperskill.tictactoe_with_al.part_4.StateOfGame.Playing;
import com.bad_java.homework.hyperskill.tictactoe_with_al.part_4.StateOfGame.StateOfGame;
import com.bad_java.homework.hyperskill.tictactoe_with_al.part_4.StateOfGame.Unknown;
...
public class Game {
    ...
    private boolean checkOpponent(String opponent){
       if ("user".equals(opponent) || "easy".equals(opponent) || "medium".equals(opponent) ) {
           return true;
       }
       return false;
    }
